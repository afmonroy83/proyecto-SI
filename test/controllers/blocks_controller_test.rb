...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { nBlock: @block.nBlock, quarter_id: @block.quarter_id } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { nBlock: @block.nBlock, quarter_id: @block.quarter_id } }
